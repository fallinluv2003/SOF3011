    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            <div class="d-flex align-items-center">
                ...
                <h2 class="fs-2 m-0">Nhà sản xuất</h2>
            </div>
        ...
        <div class="container-fluid px-4">
            <form action="/assignment/nha-san-xuat/add" method="POST">
                <div class="row">
                    <div class="col-6">
                        <label>Mã: </label>
                        <input type="text" class="form-control" name="ma" value="${nsx.ma}" required/>
                    </div>
                    <div class="col-6">
                        <label>Tên: </label>
                        <input type="text" class="form-control" name="ten" value="${nsx.ten}" required/>
                    </div>
                    ...
                    <table class="table bg-white rounded shadow-sm table-hover">
                        ...
                        <c:forEach items="${listNSX}" var="nsx">
                            <tr>
                                ...
                                <td>${nsx.ten}</td>
                                <td>
                                    <a href="/assignment/nha-san-xuat/detail?id=${nsx.id}" class="btn btn-primary "
                                       tabindex="-1" role="button"
                                       aria-disabled="true">Detail</a>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal_${nsx.id}">
                                        Update
                                    </button>
                                    <a href="/assignment/nha-san-xuat/remove?id=${nsx.id}" class="btn btn-danger "
                                       tabindex="-1" role="button"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal_${nsx.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/assignment/nha-san-xuat/update?id=${nsx.id}" method="POST">
