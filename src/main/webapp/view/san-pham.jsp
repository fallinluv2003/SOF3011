                    ...
                    <table class="table bg-white rounded shadow-sm table-hover">
                        ...
                        <c:forEach items="${listSP}" var="sp">
                            <tr>
                                ...
                                <td>${sp.ten}</td>
                                <td>
                                    <a href="/assignment/san-pham/detail?id=${sp.id}" class="btn btn-primary "
                                       tabindex="-1" role="button"
                                       aria-disabled="true">Detail</a>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal_${sp.id}">
                                        Update
                                    </button>
                                    <a href="/assignment/san-pham/remove?id=${sp.id}" class="btn btn-danger "
                                       tabindex="-1" role="button"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal_${sp.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/assignment/san-pham/update?id=${sp.id}" method="POST">
