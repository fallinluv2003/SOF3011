...
@WebServlet(name = "KhachHangServlet", value = {
        "/assignment/khach-hang/hien-thi",
        "/assignment/khach-hang/add",
        "/assignment/khach-hang/detail",
        "/assignment/khach-hang/remove",
        "/assignment/khach-hang/update"
})
public class KhachHangServlet extends HttpServlet {
    ...
    private void remove(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect("/assignment/khach-hang/hien-thi");
    }
