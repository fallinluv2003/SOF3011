...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            <form action="/assignment/mau-sac/add" method="POST">
                <div class="row">
                    <div class="col-6">
                        <label>Mã: </label>
                    ...
                    <table class="table bg-white rounded shadow-sm table-hover">
                        ...
                        <c:forEach items="${listMS}" var="ms">
                            <tr>
                                ...
                                <td>${ms.ten}</td>
                                <td>
                                    <a href="/assignment/mau-sac/detail?id=${ms.id}" class="btn btn-primary "
                                       tabindex="-1" role="button"
                                       aria-disabled="true">Detail</a>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal_${ms.id}">
                                        Update
                                    </button>
                                    <a href="/assignment/mau-sac/remove?id=${ms.id}" class="btn btn-danger "
                                       tabindex="-1" role="button"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal_${ms.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/assignment/mau-sac/update?id=${ms.id}" method="POST">
