...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            <form action="/assignment/cua-hang/add" method="POST">
                <div class="row">
                    <div class="col-6">
                        <label>Mã: </label>
                        <input type="text" class="form-control" name="ma" value="${ch.ma}" required/>
                    </div>
                    <div class="col-6">
                        <label>Tên: </label>
                        <input type="text" class="form-control" name="ten" value="${ch.ten}" required/>
                    </div>
                    <div class="col-6">
                        <label>Địa chỉ: </label>
                        <input type="text" class="form-control" name="diaChi" value="${ch.diaChi}" required/>
                    </div>
                    <div class="col-6">
                        <label>Thành phố: </label>
                        <input type="text" class="form-control" name="thanhPho" value="${ch.thanhPho}" required/>
                    </div>
                    <div class="col-6">
                        <label>Quốc gia: </label>
                        <input type="text" class="form-control" name="quocGia" value="${ch.quocGia}" required/>
                    </div>
                    <div class="col-6">
                    ...
                    <table class="table bg-white rounded shadow-sm table-hover">
                        ...
                        <c:forEach items="${listCH}" var="ch">
                            <tr>
                                ...
                                <td>${ch.quocGia}</td>
                                <td>
                                    <a href="/assignment/cua-hang/detail?id=${ch.id}" class="btn btn-primary "
                                       tabindex="-1" role="button"
                                       aria-disabled="true">Detail</a>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal_${ch.id}">
                                        Update
                                    </button>
                                    <a href="/assignment/cua-hang/remove?id=${ch.id}" class="btn btn-danger "
                                       tabindex="-1" role="button"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal_${ch.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/assignment/cua-hang/update?id=${ch.id}" method="POST">
