...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid px-4">
            <form action="/assignment/chuc-vu/add" method="POST">
                <div class="row">
                    <div class="col-6">
                        <label>Mã: </label>
                        <input type="text" class="form-control" name="maCV" value="${cv.ma}" required/>
                    </div>
                    <div class="col-6">
                        <label>Tên: </label>
                        <input type="text" class="form-control" name="tenCV" value="${cv.ten}" required/>
                    </div>
                    ...
                    <table class="table bg-white rounded shadow-sm table-hover">
                        ...
                        <c:forEach items="${listCV}" var="cv">
                            <tr>
                                ...
                                <td>${cv.ten}</td>
                                <td>
                                    <a href="/assignment/chuc-vu/detail?id=${cv.id}" class="btn btn-primary "
                                       tabindex="-1" role="button"
                                       aria-disabled="true">Detail</a>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal_${cv.id}">
                                        Update
                                    </button>
                                    <a href="/assignment/chuc-vu/remove?id=${cv.id}" class="btn btn-danger "
                                       tabindex="-1" role="button"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal_${cv.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="/assignment/chuc-vu/update?id=${cv.id}" method="POST">
